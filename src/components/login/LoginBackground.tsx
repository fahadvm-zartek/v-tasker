...
const LoginBackground = ({ children, footer }: LoginBackgroundProps) => {
  return (
    <div className="flex min-h-screen min-h-dvh flex-col">
      <main className="relative flex flex-1 items-center justify-center overflow-hidden bg-[#f7f7f5] px-5 py-10 text-[#1B3061]">
